...
from apps.gitops.api.services.utils import get_port_from_url


# TODO: figure out rathole reload options (code/ platform specific isssue)
class RatholeConfigurator:
    ...
    def is_port_in_use(self, port):
        ...
        with socket.socket(socket.AF_INET, socket.SOCK_STREAM) as s:
            return s.connect_ex((settings.RATHOLE_SERVER_HOST, port)) == 0
